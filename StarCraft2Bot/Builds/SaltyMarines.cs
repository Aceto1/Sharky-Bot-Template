...
namespace StarCraft2Bot.Builds
{
    public class SaltyMarines : Build
    {
        ...
        public override void StartBuild(int frame)
        {
            ...
            BuildOrder.Enqueue(new BuildAction(new SupplyCondition(22, MacroData), new ProductionStructureDesire(UnitTypes.TERRAN_BARRACKS, 2, MacroData)));
            BuildOrder.Enqueue(new BuildAction(new SupplyCondition(22, MacroData), new AddonStructureDesire(UnitTypes.TERRAN_BARRACKSTECHLAB, 1, MacroData)));
            ...
            BuildOrder.Enqueue(new BuildAction(new SupplyCondition(50, MacroData), new ProductionStructureDesire(UnitTypes.TERRAN_COMMANDCENTER, 3, MacroData)));
